...
namespace Tbx
{
    ...
    */
    struct Transfo
    {
        ...
        static inline float MINOR(const Transfo& m, const int r0, const int r1, const int r2, const int c0, const int c1, const int c2) {
            return m[4*r0+c0] * (m[4*r1+c1] * m[4*r2+c2] - m[4*r2+c1] * m[4*r1+c2]) -
                m[4*r0+c1] * (m[4*r1+c0] * m[4*r2+c2] - m[4*r2+c0] * m[4*r1+c2]) +
                m[4*r0+c2] * (m[4*r1+c0] * m[4*r2+c1] - m[4*r2+c0] * m[4*r1+c1]);
        }

        inline Transfo adjoint() const {
        ...
        inline float det() const { return m[0] * MINOR(*this, 1, 2, 3, 1, 2, 3) -
        ...
        inline friend std::ostream& operator<< ( std::ostream& ofs, const Transfo& tr ) {
